...
log_file="/app_config/shairport-sync/logs/generate_airplay2_services.log"
...
CONFIG_DIR="/app_config/shairport-sync/config"
...
#
# Fix: persist the name -> port assignment to /app_config (this addon's
...
#!/usr/bin/with-contenv bashio
mkdir -p /app_config/cast-bridge/logs
exec python3 /usr/sbin/cast_bridge_manager.py >> /app_config/cast-bridge/logs/cast_bridge_manager.log 2>&1
EOF
...
while read -r sink; do
    ...
    player_log="/app_config/shairport-sync/logs/${friendly_name}-ap2.log"
