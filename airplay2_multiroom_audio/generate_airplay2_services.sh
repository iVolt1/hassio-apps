...
#
# Fix: persist the name -> port assignment to /config (the one path
# this addon actually keeps across restarts) and reuse it forever,
# only falling forward to a new port for a given name if its
